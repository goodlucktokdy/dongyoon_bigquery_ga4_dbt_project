...
def load_data():
    data = {}
    try:
        data['browsing_style'] = pd.read_csv('.mart/mart_browsing_style.csv')
        data['deep_specialists'] = pd.read_csv('.mart/mart_deep_specialists.csv')
        data['variety_seekers'] = pd.read_csv('.mart/mart_variety_seekers.csv')
        data['device_friction'] = pd.read_csv('.mart/mart_device_friction.csv')
        data['cart_abandon'] = pd.read_csv('.mart/mart_cart_abandon.csv')
        data['promo_quality'] = pd.read_csv('.mart/mart_promo_quality.csv')
        data['time_conversion'] = pd.read_csv('.mart/mart_time_to_conversion.csv')
        data['bundle_strategy'] = pd.read_csv('.mart/mart_bundle_strategy.csv')
